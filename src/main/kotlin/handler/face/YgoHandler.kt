...
object YgoHandler : FramesHandler {
    ...
    // 卡片背景
    private val monsterRh by lazy { getJarImage("statistic/ygo/card/monster_rh.jpg") }
    private val monsterTc by lazy { getJarImage("statistic/ygo/card/monster_tc.jpg") }
    private val monsterTt by lazy { getJarImage("statistic/ygo/card/monster_tt.jpg") }
    private val monsterXg by lazy { getJarImage("statistic/ygo/card/monster_xg.jpg") }
    private val monsterYs by lazy { getJarImage("statistic/ygo/card/monster_ys.jpg") }
    private val spell by lazy { getJarImage("statistic/ygo/card/spell.jpg") }
    private val trap by lazy { getJarImage("statistic/ygo/card/trap.jpg") }

    // 属性
    private val attrDivine by lazy { getJarImage("statistic/ygo/attr/divine.png") }
    private val attrLight by lazy { getJarImage("statistic/ygo/attr/light.png") }
    private val attrDark by lazy { getJarImage("statistic/ygo/attr/dark.png") }
    private val attrEarth by lazy { getJarImage("statistic/ygo/attr/earth.png") }
    private val attrFire by lazy { getJarImage("statistic/ygo/attr/fire.png") }
    private val attrWind by lazy { getJarImage("statistic/ygo/attr/wind.png") }
    private val attrWater by lazy { getJarImage("statistic/ygo/attr/water.png") }

    private val attrSpell by lazy { getJarImage("statistic/ygo/attr/spell.png") }
    private val attrTrap by lazy { getJarImage("statistic/ygo/attr/trap.png") }
    ...
    // 特殊 魔法陷阱卡
    private val iconCd by lazy { getJarImage("statistic/ygo/icon/cd.png") }
    private val iconFj by lazy { getJarImage("statistic/ygo/icon/fj.png") }
    private val iconSg by lazy { getJarImage("statistic/ygo/icon/sg.png") }
    private val iconYs by lazy { getJarImage("statistic/ygo/icon/ys.png") }
    private val iconYx by lazy { getJarImage("statistic/ygo/icon/yx.png") }
    private val iconZb by lazy { getJarImage("statistic/ygo/icon/zb.png") }

    // 其他
    private val logo by lazy { getJarImage("statistic/ygo/logo.png") }
